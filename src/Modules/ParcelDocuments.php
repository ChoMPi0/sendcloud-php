...
class ParcelDocuments extends Module
{
     ...
     * Sendcloud will generate the correct type of document for your shipment when you Create a parcel, provided that you have filled in all the information related to the parcel contents, value and invoice. Use this endpoint to retrieve these documents in your preferred format.
     * 
